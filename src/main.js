...
const task=new Task( "!!!!!EditedEditedEdited","some task about cats","Complete","High",true,[],"Иванов Иван");
const task1=new Task( "!!!!!NEWNEWNEW","some task about cats","Complete","High",true,[],"Иванов Иван")
...
contr.showTask("1");
//contr.getFeed(0, 10, { status: 'To Do' });
//contr.addTask(task1);
